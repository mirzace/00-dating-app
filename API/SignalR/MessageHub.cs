...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public MessageHub(IMapper mapper, IMessageRepository messageRepository, IHubContext<PresenceHub> presenceHub,
            PresenceTracker tracker, IUserRepository userRepository)
        {
